...
# Simulación de lectura de entrada directamente en VSCode en lugar de usar fileinput
def main():
    operacion = input("Ingrese operación (C para cifrar, D para descifrar): ").strip()
    texto = input("Ingrese el texto: ").strip()
    clave = input("Ingrese la clave (4 letras): ").strip()
    letterA = clave[0]
    letterB = clave[1]
    letterC = clave[2]
    letterD = clave[3]
